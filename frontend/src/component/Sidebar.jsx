...
const Sidebar = ({ blogs, onSaveBlog, onLogout, onViewBlog, onDeleteBlog }) => {
  return (
    <div className="fixed top-0 left-0 h-screen w-72 bg-[#111] text-white p-5 shadow-lg z-50 overflow-y-auto">
      <h2 className="text-green-400 text-xl font-bold mb-5 flex items-center gap-2">
